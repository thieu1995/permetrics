...
The **Relative Absolute Error (RAE)** :cite:`armstrong1992error` is a regression metric that compares the absolute error of your model to the absolute error of a simple "no-knowledge" baseline model (which simply predicts the mean of the actual values).
