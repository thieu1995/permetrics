...
+ `Link to equation <https://www.statology.org/residual-standard-error-r/>`_
+ `Link to equation <https://machinelearningmastery.com/degrees-of-freedom-in-machine-learning/>`_
