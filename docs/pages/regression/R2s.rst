...
Example to use: R2s function::
	...
	print(obj1.pearson_correlation_index_square(clean=True, decimal=5))
	...
	for multi_output in multi_outputs:
	    print(obj2.pearson_correlation_index_square(clean=True, multi_output=multi_output, decimal=5))
