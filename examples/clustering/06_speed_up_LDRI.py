...
sse02 = cm.log_det_ratio_index()
print("result: ", sse02, time.perf_counter() - time02 )

time03 = time.perf_counter()
s3 = cut.calculate_log_det_ratio_index(data, labels)
print("result: ", s3, time.perf_counter() - time03)
