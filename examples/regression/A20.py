...
result = obj1.a20_index(clean=True, decimal=5)
print(f"1-D array, OOP style: {result}")

### C2. Using functional style
obj2 = Metrics()
result = obj2.a20_index(clean=True, decimal=5, y_true=y_true2, y_pred=y_pred2)
...
for multi_output in multi_outputs:
    result = obj3.a20_index(clean=True, multi_output=multi_output, decimal=5)
