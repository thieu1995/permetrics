...
result = obj1.mean_absolute_error(clean=True, decimal=5)
print(f"1-D array, OOP style: {result}")

### C2. Using functional style
obj2 = Metrics()
result = obj2.mean_absolute_error(clean=True, decimal=5, y_true=y_true2, y_pred=y_pred2)  # Pass the data here, remember the keywords (y_true, y_pred)
...
for multi_output in multi_outputs:
    result = obj3.mean_absolute_error(clean=False, multi_output=multi_output, decimal=5)
